...
*  and thereby take the lock on the monitor object the block is synchronized on, the thread can enter other Java code
...
*   it has access to all blocks synchronized on the same monitor object. This is called reentrance. 
